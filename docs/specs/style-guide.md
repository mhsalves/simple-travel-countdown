...
| Header actions (countdown page) | `Button`s in the header, right aligned, 8px gap | **Share** `contained` with `ShareRounded` icon (primary emphasis) and **Create my countdown** `text`; the brand name is hidden below `sm` |
